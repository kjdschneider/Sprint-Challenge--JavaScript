...
class Dinosaur {
  constructor(dinoAttrs){
    this.name = dinoAttrs.name;
    this.diet = dinoAttrs.diet;
    this.weight = dinoAttrs.weight;
    this.length = dinoAttrs.length;
    this.period = dinoAttrs.period;
  }
}
